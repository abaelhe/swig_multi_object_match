...
SWIGINTERN PyObject *_wrap_mmapfile_compute_fingerprints(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0; char *arg1 = (char *) 0 ; size_t arg2 ; int res1 ; char *buf1 = 0 ; int alloc1 = 0 ; size_t val2 ;
  ...
  res1 = SWIG_AsCharPtrAndSize(obj0, &buf1, NULL, &alloc1); if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "mmapfile_compute_fingerprints" "', argument " "1"" of type '" "char *""'"); }
   arg1 = reinterpret_cast< char * >(buf1); ecode2 = SWIG_AsVal_size_t(obj1, &val2); if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "mmapfile_compute_fingerprints" "', argument " "2"" of type '" "size_t""'"); }
    arg2 = static_cast< size_t >(val2); result = mmapfile_compute_fingerprints(arg1,arg2);
